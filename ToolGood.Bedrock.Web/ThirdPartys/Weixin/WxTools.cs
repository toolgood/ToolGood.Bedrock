...
namespace ToolGood.Bedrock.Web.ThirdPartys.Weixin
{
    ...
    public class WxTools
    {
        ...
        private static AntiDuplication.AntiDupCache<string, WxAccessToken> cache = new AntiDuplication.AntiDupCache<string, WxAccessToken>(100, 60 * 60 * 2 - 30);
