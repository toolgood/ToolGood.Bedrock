...
namespace ToolGood.Bedrock.Dependency
{
    public class ContainerManager
    {
        ...
        public static ContainerManager UseAutofacContainer(ContainerBuilder builder = null)
        {
        ...
        /// <param name="serviceName">服务名称</param>
        /// <param name="lifeStyle">生命周期</param>
        public ContainerManager RegisterType<T>(Type interceptType, string serviceName = null, LifeStyle lifeStyle = LifeStyle.Singleton)
        {
            this.Container.RegisterType<T>(new Type[] { interceptType }, serviceName, lifeStyle);
            return this;
        }
        ...
        public ContainerManager RegisterAssemblyTypes(string assemblyName)
        {
            var assembly = Assembly.Load(assemblyName);
            this.Container.RegisterAssemblyTypes(assembly, null, LifeStyle.PerLifetimeScope);
            return this;
        }
        ...
        /// <param name="assemblyName">程序集名</param>
        /// <param name="lifeStyle">生命周期</param>
        public ContainerManager RegisterAssemblyTypes(string assemblyName, LifeStyle lifeStyle = LifeStyle.PerLifetimeScope)
        {
            var assembly = Assembly.Load(assemblyName);
            this.Container.RegisterAssemblyTypes(assembly, null, lifeStyle);
            return this;
        }
        ...
        /// <param name="predicate">筛选条件</param>
        /// <param name="lifeStyle">生命周期</param>
        public ContainerManager RegisterAssemblyTypes(string assemblyName, Func<Type, bool> predicate = null, LifeStyle lifeStyle = LifeStyle.PerLifetimeScope)
        {
            var assembly = Assembly.Load(assemblyName);
            this.Container.RegisterAssemblyTypes(assembly, predicate, lifeStyle);
            return this;
        }
        ...
        /// <param name="predicate">筛选条件</param>
        /// <param name="lifeStyle">生命周期</param>
        public ContainerManager RegisterAssemblyTypes(string assemblyName, Type[] interceptTypeList, Func<Type, bool> predicate = null, LifeStyle lifeStyle = LifeStyle.PerLifetimeScope)
        {
            var assembly = Assembly.Load(assemblyName);
            this.Container.RegisterAssemblyTypes(assembly, interceptTypeList, predicate, lifeStyle);
            return this;
        }
        #endregion
