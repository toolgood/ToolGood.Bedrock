...
namespace ToolGood.Bedrock
{
    ...
    /// 中国日历信息实体类
    /// </summary>
    public sealed class ChineseCalendarUtil
    {
        ...
        public ChineseCalendarUtil(DateTime date)
        {
            m_SolarDate = date;
            LoadFromSolarDate();
        }
        ...
        /// <param name="day">阴历日</param>
        /// <param name="IsLeapMonth">是否闰月</param>
        public static ChineseCalendarUtil FromLunarDate(int year, int month, int day, bool IsLeapMonth)
        {
            DateTime dt = GetDateFromLunarDate(year, month, day, IsLeapMonth);
            return new ChineseCalendarUtil(dt);
        }
        /// <summary>
        /// 从阴历创建日历实体
        /// </summary>
        /// <param name="date">阴历日期</param>
        /// <param name="IsLeapMonth">是否闰月</param>
        public static ChineseCalendarUtil FromLunarDate(DateTime date, bool IsLeapMonth)
        {
        ...
        /// <param name="IsLeapMonth">是否闰月</param>
        public static ChineseCalendarUtil FromLunarDate(string date, bool IsLeapMonth)
        {
        ...
        private static readonly string[] ChineseWeekName = new string[] { "星期天", "星期一", "星期二", "星期三", "星期四", "星期五", "星期六" };
        ...
        private static readonly string[] Constellations = new string[] { "白羊座", "金牛座", "双子座", "巨蟹座", "狮子座", "处女座", "天秤座", "天蝎座", "射手座", "摩羯座", "水瓶座", "双鱼座" };
        private static readonly string[] BirthStones = new string[] { "钻石", "蓝宝石", "玛瑙", "珍珠", "红宝石", "红条纹玛瑙", "蓝宝石", "猫眼石", "黄宝石", "土耳其玉", "紫水晶", "月长石，血石" };
